...
print(totalmonths,totalProfit,AvgChange,GreatestIncrease,GreatestDecrease,GreatestIncreaseDate,GreatestDecreaseDate)

print("Financial Analysis")
print("-------------------------------")
print("Number of months:" + str(month_count))
print("Total P/L:" + str(total_value)
print(f"Average change in P/L: ${AvgChange}")